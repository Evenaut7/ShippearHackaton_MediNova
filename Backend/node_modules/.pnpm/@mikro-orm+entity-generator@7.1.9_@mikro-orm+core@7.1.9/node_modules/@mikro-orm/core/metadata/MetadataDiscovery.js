                ...
                Object.values(meta.properties).forEach(prop => {
                    ...
                    if (properties[prop.name] && properties[prop.name].type !== prop.type) {
                        ...
                        if (prevEntity && nextEntity) {
                            merged.entity = (() => Utils.unique([...Utils.asArray(prevEntity()), ...Utils.asArray(nextEntity())]));
                        }
                        if (merged.target && prop.target) {
                            merged.target = Utils.unique([...Utils.asArray(merged.target), ...Utils.asArray(prop.target)]);
                        }
